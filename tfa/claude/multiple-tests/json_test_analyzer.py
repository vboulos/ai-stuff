...
Examples:
  ...
  python3 json_test_analyzer.py --sample
  
  # Analyze all failures in JSON file
  python3 json_test_analyzer.py test_results.json
  
  # Save results to output file
  python3 json_test_analyzer.py input.json --output results.json
  
  # Limit to first 3 failures
  python3 json_test_analyzer.py input.json --max-failures 3
  
  # Specify framework for all tests
  python3 json_test_analyzer.py input.json --framework pytest
